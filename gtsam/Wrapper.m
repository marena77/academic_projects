...
load('DataMappingFall2020.mat');
% load('DataSquareFall2020.mat');
...
% [LandMarksComputed, AllPosesComputed] = SLAMusingGTSAM(DetAll, K, TagSize, qIMUToC, TIMUToC, IMU, LeftImgs, TLeftImgs);
